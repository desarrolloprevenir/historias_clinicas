...
@Component({
  ...
  templateUrl: './g-admin-sucursal.component.html',
  styleUrls: ['./g-admin-sucursal.component.css']
})
export class GAdminSucursalComponent implements OnInit {
  public mymodel;
...
// console.log('oi');
  ...
  this.id_sucu.setValue(this.infoSucursal.id_sucursales);
